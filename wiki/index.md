...
- [[LLM-Agent工程实践]] — 约束中激发能力：驾驭工程方法论与Agent架构 (20 视频)

- [[AI与生产力]] — 阅读>写作：AI作为第二大脑的思考伙伴 (4 视频)
- [[RLVR训练范式]] — 通过可验证奖励训练语言模型：环境设计 > 数据质量 (1 视频)
- [[Google AI零代码工具链]] — Stitch+Antigravity+Flutter全流程零代码开发 (1 视频)

## 创业与认知

- [[技术人创业与产品思维]] — 技术人的认知陷阱：从"写好代码"到"做好生意" (8 视频)

## 核心概念

- [[驾驭工程]] — Agent工程的方法论框架：模型以外的全部工程体系
- [[源码锚定]] — AI输出严格基于源文件：可追溯性抑制幻觉，局限在于只回答你已上传的
- [[MVP思维]] — 做减法：跨领域的元模式，约束产生聚焦
- [[RLVR训练范式]] — 强化学习+可验证奖励：从SFT的模仿转向环境的探索
- [[MCP Server]] — AI工具互操作协议：动态加载、按需发现
- [[Google AI零代码工具链]] — Google三件套的协作编排
- [[第二大脑]] — AI驱动的动态知识管理：从存档到思考伙伴
- [[思考模式]] — 不让AI写的反直觉协作方式：提问>产出
- [[非确定性直觉]] — 概率性系统需要全新的操作直觉
- [[上下文工程]] — 精准控制信息流：给AI的不是越多越好，而是越准越好
- [[确定性输出]] — 脚本替代LLM推理：把"理解意图"和"执行计算"分离
- [[Claude Skill]] — 可编程工作流：指令+引用+脚本的三层约束架构
- [[AI Agent自验证循环]] — 测试即反馈信号：Agent的写→跑→修闭环
- [[AI评估体系]] — 四种评估类型与对齐方法论：代码>人工>LLM-as-Judge>用户（3 视频）
- [[LLM-as-Judge]] — 用LLM评判LLM：不对齐人工标签就是垃圾进垃圾出
- [[复利工程]] — 每份工作让下一份更容易：提示生成提示，系统设计>单次执行
- [[智能体分工]] — 不追求全能Agent，像招聘专家一样各司其职
- [[Vibe Building]] — Vibe Coding/Marketing/Designing界限消融后的系统化构建
- [[微交互设计]] — 细节动画的累积制造"手感"：功能不是壁垒，感受才是
- [[设计曝光]] — 持续接触好设计内化直觉：知道该做什么比知道怎么做更重要
- [[乘风策略]] — 不创造需求，搭已经爆发的注意力便车：48小时内发布解决方案
- [[AI搜索优化]] — 优化内容被ChatGPT/Perplexity推荐：转化率是Google的4-17倍
- [[规范驱动开发]] — 用结构化规范替代vibe coding的人肉护栏：需求→设计→执行的可复现工作流
- [[基于属性的测试]] — 声明不变量而非写用例：从EARS需求到属性测试的贯穿线
- [[原型优先开发]] — 先原型再设计再文档：AI把原型成本压到零后流程倒转
- [[个人操作系统]] — all text files all the way down：把"你"编码为markdown文件让AI对齐你的意图
- [[AI驱动的产品设计工作流]] — 从"设计师产出"到"AI提炼+人判断"：多源数据提炼、方案生成自动化、策展替代产出
- [[AI驱动的产品工作流]] — AI补全遗忘需求、Chat+Document双模式、PM从写文档转向迭代判断
- [[AI原生商业模式]] — 构建成本趋零+不融资+现金流为正：千万美元年收入不是VC回报但足以改变生活
- [[内部dogfooding]] — 内外反馈的海拔差异：交互层深层反馈 vs 功能层使用反馈，前提是组织文化允许跨团队批评
- [[主动式Agent]] — 不等待指令自主执行：挖掘unknown unknowns是AI真正的杠杆，安全是阿喀琉斯之踵
- [[提示注入]] — 指令与数据无法分离的架构缺陷：Agent越自主攻击面越大，当前只能靠权限隔离
- [[异步Agent范式]] — 从"等AI回复"到"交办任务、过会儿来看结果"：非技术用户的下一个关键解锁
- [[Agent原生架构]] — 以Agent为核心构建软件：Parity/Granularity/Composability/Emerging Capability四原则
- [[上下文智能]] — AI主动查询分散上下文：从"人工喂信息"到"AI自己找信息"的范式翻转
- [[复利规划]] — 复利工程在产品侧的超集：规划是思想快照不是执行账本，任务系统解放规划文档
- [[任务即子Agent]] — Claude Code任务系统本质：每个任务拥有独立上下文，跨会话持久化让多实例协作成为可能
- [[Vibe Coding]] — 用自然语言引导Agent构建软件：核心竞争力从编码能力转向上下文工程+品味判断+痛觉阈值
- [[自主循环开发]] — Agent自主运行观察→分析→规划→执行→验证→学习循环：人类从参与者变为审查者
- [[开源信任系统]] — AI击溃开源的"默认允许"模型：从贡献成本过滤到担保制信任传递
- [[模型驾驶风格]] — 不同LLM的系统性行为倾向：不只是能力差异，而是"怎么用"的差异
- [[代码组织与可维护性]] — AI生成代码的模块化程度直接影响后续Agent审查和bug修复能力
- [[AI设计美学]] — 不同LLM生成UI设计时的系统性审美倾向：极简vs丰富、克制vs大胆
- [[物理AI]] — 给已有机器注入智能而非造人形机器人：AI真正影响在农业矿业建筑而非软件
- [[激进实用主义]] — 去情绪化决策+安静做事+最佳想法胜出：从"什么实际有效"出发而非哲学推导
- [[代码即最高保真]] — 代码是设计交付的最高保真形式：Draft PR替代Figma mock，消除设计-实现翻译损耗
- [[设计-开发桥梁]] — 设计师与工程师从"交接"转向"融合"：代码库内理解约束、交付实现、角色边界流动但决策权属专家
- [[AI微应用]] — 单功能极致化的AI产品：一屏一按钮一变换，从"神经"出发找到高意图利基
- [[高意图输入]] — 输入越准转化越高：照片/地址/物品等高信号输入天然筛选高价值用户
